...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'C:\Users\deves\OneDrive\Desktop\thriftapp'; docker-compose up --build"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'C:\Users\deves\OneDrive\Desktop\thriftapp\flutter_app'; flutter run"
